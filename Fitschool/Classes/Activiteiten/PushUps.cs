    ...
    public class PushUps
    {
        public bool Start()
        {
            ...
            try
            {
                ...
                new FormMessageBox("Ga op de grond liggen, boven de sensor.\nDruk dan op beginnen.", "Pushups", "Beginnen");
